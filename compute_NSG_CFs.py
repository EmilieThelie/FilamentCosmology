...
while i < len(results_SS):
  RR_SS = Ns*Ns*(2./3.)*np.pi*(results_SS[i][1]**3.0 - results_SS[i][0]**3.0) / boxsize**3.0
  RR_SN = Ns*Nn*(2./3.)*np.pi*(results_SN[i][1]**3.0 - results_SN[i][0]**3.0) / boxsize**3.0
  RR_SG = Ns*Ng*(2./3.)*np.pi*(results_SG[i][1]**3.0 - results_SG[i][0]**3.0) / boxsize**3.0
  RR_NN = Nn*Nn*(2./3.)*np.pi*(results_NN[i][1]**3.0 - results_NN[i][0]**3.0) / boxsize**3.0
  RR_GG = Ng*Ng*(2./3.)*np.pi*(results_GG[i][1]**3.0 - results_GG[i][0]**3.0) / boxsize**3.0
