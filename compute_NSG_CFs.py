...
results_SS = countpairs(1, nthreads, binfile, boxsize=(boxsize, boxsize, boxsize), X1=saddles_pos[:,0].astype(np.float32), Y1=saddles_pos[:,1].astype(np.float32), Z1=saddles_pos[:,2].astype(np.float32), periodic=1, verbose=True)
results_SN = countpairs(0, nthreads, binfile, boxsize=(boxsize, boxsize, boxsize), X1=saddles_pos[:,0].astype(np.float32), Y1=saddles_pos[:,1].astype(np.float32), Z1=saddles_pos[:,2].astype(np.float32), X2=nodes_pos[:,0].astype(np.float32), Y2=nodes_pos[:,1].astype(np.float32), Z2=nodes_pos[:,2].astype(np.float32), periodic=1, verbose=True)
results_SG = countpairs(0, nthreads, binfile, boxsize=(boxsize, boxsize, boxsize), X1=saddles_pos[:,0].astype(np.float32), Y1=saddles_pos[:,1].astype(np.float32), Z1=saddles_pos[:,2].astype(np.float32), X2=gals_pos[:,0].astype(np.float32),  Y2=gals_pos[:,1].astype(np.float32),  Z2=gals_pos[:,2].astype(np.float32), periodic=1, verbose=True)
results_NN = countpairs(1, nthreads, binfile, boxsize=(boxsize, boxsize, boxsize), X1=nodes_pos[:,0].astype(np.float32),   Y1=nodes_pos[:,1].astype(np.float32),   Z1=nodes_pos[:,2].astype(np.float32), periodic=1, verbose=True)
results_GG = countpairs(1, nthreads, binfile, boxsize=(boxsize, boxsize, boxsize), X1=gals_pos[:,0].astype(np.float32),    Y1=gals_pos[:,1].astype(np.float32),    Z1=gals[:,2].astype(np.float32), periodic=1, verbose=True)
